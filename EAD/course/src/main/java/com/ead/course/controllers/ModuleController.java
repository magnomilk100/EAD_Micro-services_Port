...
public class ModuleController {
    ...
    public ResponseEntity<Object> saveModule(@PathVariable(value="courseId") UUID courseId,
        ...
        if(!courseModelOptional.isPresent()){
            return ResponseEntity.status(HttpStatus.CONFLICT).body("Course not found with this id " + courseId);
        }
    ...
    public ResponseEntity<Object> deleteModule(@PathVariable(value="courseId") UUID courseId,
        ...
        if(!moduleModelOptional.isPresent()){
            return ResponseEntity.status(HttpStatus.CONFLICT).body("Module not found for this courseId " + courseId);
        }
    ...
    public ResponseEntity<List<ModuleModel>> getAllModuleByCourse(@PathVariable(value="courseId") UUID courseId){
